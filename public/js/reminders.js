    ...
    tbody.innerHTML = reminders.map(reminder => {
        ...
        return `
            <tr>
                ...
                <td>
                    <button class="btn-secondary btn-edit-reminder" data-id="${reminder.id}" style="margin-right: 0.5rem;">
                        ✏️ Modifier
                    </button>
                    <button class="btn-cancel btn-delete-reminder" data-id="${reminder.id}">
                        🗑️ Supprimer
                    </button>
                </td>
            </tr>`;
